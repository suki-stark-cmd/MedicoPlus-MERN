...
const RelatedDoctors = ({ speciality, docId }) => {
    ...
    return (
        <div className='flex flex-col items-center gap-4 my-16 text-[#262626] animate-fadeIn'>
            <h1 className='text-3xl font-extrabold text-blue-900 drop-shadow'>Related Doctors</h1>
